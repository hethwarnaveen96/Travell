...
<table>
      ...
      <tr>
        <td>Day 1</td>
        <td>Arrival Kolkata</td>
        <td>Afternoon Arrival at Kolkata Railway Station/Airport-Transfer to Hotel.
          Evening at Leisure.
          Overnight Stay</td>
      </tr>
      <tr>
        <td>Day 2</td>
        <td>Kolkata Sightseeing</td>
        <td>After Breakfast proceed to local sight seeing.
          Visit Kalighat Temple, Birla Mandir, Indian Museum, Victoria Memorial,Eden gardens , Birla Planetorium,Saheed Minar, Raj Bhawan,BBD Bagh,Writers Building,GPO, Howrah Bridge etc.
          NOTE: * Shown from Outside</td>
      </tr>
      <tr>
        <td>Day 3</td>
        <td>Kolkata Sightseeing</td>
        <td>After Breakfast Proceed to visit Belur Math, Dakshineshwar Kali Temple,Science City, Niccoo Park,Zoological Gardens etc. 
          Overnight Stay</td> 
      </tr>
      <tr>
        <td>Day 4</td>
        <td>Depart Kolkata</td>
        <td>After Breakfast, Checkout from the Hotel and transfer to Railway Station / Airport.</td>
      </tr>
    </table> 
    <br>
    <br>
    ...
    <form method="POST" action="Payment.php">
      ...
      <input type="package" id="name" name="package" value="KOLKATA TOUR" required><br><br>
      
      <label for="date">Date:</label>
      <input type="date" id="date" name="date" min="2024-03-03" max="2024-03-31" required><br><br>
