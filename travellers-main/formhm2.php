...
<table>
      ...
      <tr>
        <td>Day 1</td>
        <td>Arrive Bagdogra – Gangtok</td>
        <td>On arrival at Bagdogra Airport, our executive will meet and welcome at the Airport. 
          Later, you will be escorted to board your vehicle to Gangtok (5500 Ft/1677 Mts, 130 Kms/ 04 to 05 Hrs). 
          Sign in with the lodging at Bagdogra. 
          Rest of the day is for relaxtion or look into your beautiful surroundings. 
          Night stay at the lodging.</td>
      </tr>
      <tr>
        <td>Day 2</td>
        <td>Gangtok</td>
        <td>Have your morning breakfast and then move ahead for trip to Tshangu Lake - located at a height of 12400ft/ 3780 Mts/ 43kms in 3hrs restricted, with a normal insight of 50 ft. 
          The cool water of the Lake is splendidly adjusted with the beautiful excellence around. 
          (In the event of Landslide or other reasons, the lake will be shut down and you will be offered some other tourist attractions.). 
          Get back to the hotel for overnight stay.</td>
      </tr>
      <tr>
        <td>Day 3</td>
        <td>Gangtok – Darjeeling</td>
        <td>After breakfast, strive for a Half Day (04 hrs) touring blanket Jhakri Water Falls alongside Droul Chorthen, Directorate of Handicraft & Handloom (Shut on Sunday), Research Institute of Tibetology (shut on Sunday), and Flower Show. 
          Later toward the evening, sign out from the lodging and exchange to Darjeeling (7380 Ft/ 2250 Mts, 115 Kms/ 05 to 06 Hrs). 
          Sign in with the lodging at Darjeeling.
           Night stay at the lodging.</td> 
      </tr>
      <tr>
        <td>Day 4</td>
        <td>Darjeeling</td>
        <td>On fourth day morning, continue for tour to Tiger Hills (8364 Ft/ 2550 Mts at around 4 AM) to view sunrise over Kanchendzonga Peak (subject to clear climate). On the way, visit Ghoom Monastery, Japanese Temple, Batasia Loop. Have your breakfast, travel for a half-day touring to Peace pagoda, Darjeeling Ropeway Ride (Ticket cost excluded & will be approx INR 180.00 for every individual) Tenzing & Gombu Rock, Tibetan Refugee Self-Help Center (Shut on Sunday), Padmaja Naidu Himalayan Zoological Park & Himalayan Mountaineering Institute (shut on Thursday), & surrounding perspective of Tea Estate. 
          Return back to hotel for night stay.</td>
      </tr>
      <tr>
        <td>Day 5</td>
        <td>Darjeeling – Gangtok</td>
        <td>After morning breakfast, check-out from the lodging (Check-out before 12.00 twelve) and continue to (IXB) Bagdogra Airport (100 Kms/ 03 to 04 Hrs) to catch your flight to fly over to Chennai. Return with sweet memories.</td> 
      </tr>
    </table> 
    <br>
    <br>
    ...
    <form method="POST" action="Payment.php">
      ...
      <input type="package" id="name" name="package" value="HONEYMOON IN HIMALAYAS" required><br><br>
      
      <label for="date">Date:</label>
      <input type="date" id="date" name="date" min="2023-07-01" max="2023-08-06" required><br><br>
