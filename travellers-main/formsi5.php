...
<table>
      ...
      <tr>
        ...
        <td>On arrival at Bangalore, you will be welcomed by our tour representatives and transferred to Mysore. 
          After reaching, relax for some time before undertaking an outing of Mysore. 
          On the way, visit the Chamundi Hills, Mysore Zoo, Brindavan Gardens, Mysore Lake, and St.Philomena's Church. 
          Spend your overnight stay at the hotel in Mysore.</td>
      </tr>
      <tr>
        <td>Day 2</td>
        <td>Mysore - Ooty (180 KMS - 04 Hours drive)</td>
        <td>Take your breakfast and continue to Ooty. 
          Enjoy the day at your leisure. 
          A night tour to the Ooty Lake or the Botanical Garden is optional.
          Move back to the hotel for overnight stay.</td>
      </tr>
      <tr>
        <td>Day 3</td>
        <td>Ooty</td>
        <td>After breakfast, get ready for an exciting trip to Ooty. 
          Visit the Dodabetta Peak, the Botanical Gardens, Ooty Lake, Lamb's Rock, The Rose Garden and more. 
          Get back to the hotel for overnight stay in Ooty.</td> 
      </tr>
      <tr>
        <td>Day 4</td>
        <td>Ooty - Kodaikanal (260 KMS - 06 Hours drive)</td>
        <td>Today, continue to Kodaikanal. 
          On landing in Kodaikanal, sign in and rest at the hotel. 
          Enjoy the day at your leisure. 
      ...
      <tr>
        <td>Day 5</td>
        <td>Kodaikanal</td>
        <td>After morning breakfast, proceed for a exciting trip to Kodaikanal. 
          On the way, visit the Coaker's Walk, Green Valley View, Bryant Park, Pillar Rocks, Kodai Lake, and Kurinji Andavar Temple. 
          Return back to the hotel or resort for overnight stay.</td> 
      </tr>
      <tr>
        <td>Day 6</td>
        <td>Kodaikanal - Bangalore (450 KMS - 08 Hours drive)</td>
        <td>On the last day after breakfast, check out from the hotel and continue to Bangalore Airport/Railway Station.</td>
      </tr>
    </table> 
    <br>
    <br>
    ...
    <form method="POST" action="Payment.php">
      ...
      <input type="package" id="name" name="package" value="EXCITING SPECIAL HILL TOUR" required><br><br>
      
      <label for="date">Date:</label>
      <input type="date" id="date" name="date" min="2023-10-02" max="2023-11-16" required><br><br>
