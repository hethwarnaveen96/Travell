...
<table>
      ...
      <tr>
        <td>Day 1</td>
        <td>Varanasi - Bodhgaya</td>
        <td>On morning, arrive at Varanasi by train or flight.
           Our tour representatives will take you to Bodhgaya and sign in to the hotel for night stay.</td>
      </tr>
      <tr>
        <td>Day 2</td>
        <td>Bodhgaya – Gaya - Varanasi</td>
        <td>On the second day, visit Vishnu Path and the Bodhi tree where Lord Buddha received enlightenment. 
          Later, travel back to Varanasi.
           Move to the hotel for night stay.</td>
      </tr>
      <tr>
        <td>Day 3</td>
        <td>Varanasi – Allahabad – Varanasi</td>
        <td>Following breakfast, get ready to move to Allahabad.
          Take a holy bath in Triveni Sangam, visit Ananda Bhawan & Hanuman Temple. Later back to Varanasi, on the way visit Vindhyachal (Shakthi Peeth) & Sitamadi.
           Enjoy the rest of the day at the Varanasi hotel.</td> 
      </tr>
      <tr>
        <td>Day 4</td>
        <td>Varanasi</td>
        <td>Get up early in the morning to admire the beauty sunrise and an exciting boat ride. 
          Then, visit Lord Durga Temple, Vishwanath Temple, Tulsi Manas Mandir, Banaras Hindu University and Sarnath Museum.
           Evening move to Airport / Railway Station for your return journey.</td>
      </tr>
    </table> 
    <br>
    <br>
    ...
    <form method="POST" action="Payment.php">
      ...
      <input type="package" id="name" name="package" value="VARANASI BODH GAYA TOUR" required><br><br>
      
      <label for="date">Date:</label>
      <input type="date" id="date" name="date" min="2023-12-20" max="2024-01-31" required><br><br>
