...
<table>
      ...
      <tr>
        <td>Day 1</td>
        <td>Chennai</td>
        <td>Without a moment's delay, you arrive at Chennai. 
          Our tour representatives will welcome and transfer you to the hotel. 
          By noon, get ready for a tour to Chennai. Visit the Santhome Cathedral, Parthsarthy Temple, Kapaleeshwar Temple, Marina Beach and National Art Gallery. 
          Enjoy your overnight stay at the hotel.</td>
      </tr>
      <tr>
        <td>Day 2</td>
        <td>Chennai - Tirupati (170 KMS - 04 Hours drive)</td>
        <td>Take your breakfast in the morning. Get ready for a tour Tirupati. 
          You will be taken to the popular places of Tripati such as Tirupati Temple, Chandragiri Town, Kailasakona Waterfalls, Kalyani Dam and Agastyaswami Temple. 
          Spend your overnight stay at the hotel in Tirupati.</td>
      </tr>
      <tr>
        <td>Day 3</td>
        <td>Tirupati - Chennai (170 KMS - 04 Hours drive)</td>
        <td>After your breakfast, move out from the hotel. 
          Our tour representatives will transfer you to Chennai Airport/Railway Station for your return.</td> 
      </tr>
    </table> 
    <br>
    <br>
    ...
    <form method="POST" action="Payment.php">
      ...
      <input type="package" id="name" name="package" value="CHENNAI TIRUPATI PACKAGE" required><br><br>
      
      <label for="date">Date:</label>
      <input type="date" id="date" name="date" min="2023-08-06" max="2023-09-20" required><br><br>
