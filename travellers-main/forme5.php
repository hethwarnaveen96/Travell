...
<table>
      ...
      <tr>
        <td>Day 1</td>
        <td>Chennai</td>
        <td>After your arrival at Chennai, get into the hotel and relax for sometime. 
          Get ready to visit Valluvar kottam – A memorial which is built in tribute of the most outstanding Tamil poet, saint and philosopher Thiruvalluvar.,
           Later visit Gunidy national parkwhich is the 8th smallest National Park of India. 
          Go on to Marina beach and Mahaballipuram. 
          Spend your overnight stay at the hotel.</td>
      </tr>
      <tr>
        <td>Day 2</td>
        <td>Chennai - Pondicherry</td>
        <td>After your breakfast, visit the local sightseeing places and explore great fun. Proceed to the Besent Nagar Beach. 
          Later, visit the biggest zoos in South East Asia which is Vandalur Zoo and Go for shopping at evening. 
          Depart to Pondicherry for overnight stay at hotel.</td>
      </tr>
      <tr>
        <td>Day 3</td>
        <td>Pondicherry</td>
        <td>On the last day morning after breakfast, visit Pondicherry beach, Panjavadi Temple, Auroville, Manakkula Vinayakar Temple, Aurobindo Ashram. 
          Evening , depart to home town with charming memories of Exotic Chennai</td>      
    </table> 
    <br>
    <br>
    <br>
    ...
    <form method="POST" action="Payment.php">
      ...
      <input type="package" id="name" name="package" value="ALLURING SOUTH INDIA" required><br><br>
      
      <label for="date">Date:</label>
      <input type="date" id="date" name="date" min="2023-12-16" max="2024-01-18" required><br><br>
