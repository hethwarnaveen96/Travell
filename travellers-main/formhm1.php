...
<table>
      ...
      <tr>
        <td>Day 1</td>
        <td>Arrival To Port Blair</td>
        <td>On Arrival at Port Blair International Airport, our delegate will meet and transfer you to the hotel. 
          Register with the lodging at Port Blair. 
          Take a small break at the inn, and get ready to begin the Journey with Anthropological Museum, which shows the Tools, Art and Handcrafts of the Aboriginal Tribes of Andaman & Nicobar Islands, Models Habitats, Cellular Jail, Fisheries Museum, Science Center. 
          Continue your journey to the Corbyn's Cove shoreline. 
          Later, visit the Light and Sound Show at Cellular Jail where the adventure of the Freedom Struggle brought alive. 
          Spend your overnight stay at the hotel.</td>
      </tr>
      <tr>
        <td>Day 2</td>
        <td>Port Blair - Baratang Island</td>
        <td>Today early morning, proceed to Baratang Island (110kms) which holds the nature's best fortunes talented to the Islands. 
          Limestone hollows is an absolute spot for nature sweethearts & relaxation explorers much the same. 
          The Road venture from Port Blair to Baratang includes crossing through rivers and thick tropical woodland.
           Return once again to Port Blair by night. 
          Enjoy your night stay at the inn.</td>
      </tr>
      <tr>
        <td>Day 3</td>
        <td>Port Blair – Havelock Island</td>
        <td>After morning breakfast, move towards Havelock Island through ship from Port Blair. 
          Reach the Havelock Island and proceed to Radhanagar Beach which appraised the #7 among the finest shoreline in Asia. 
          It is a perfect spot for swimming, sea bathing and basking on The Sun Kissed Beach. 
          In the evening, move to the Port Blair (by means of ship). 
          Return again to the inn. Spend your overnight stay at the lodging.</td> 
      </tr>
      <tr>
        <td>Day 4</td>
        <td>Snorkelling at Beach</td>
        <td>After morning breakfast, continue for snorkelling outing to Elephant shoreline by motorized cruise. 
          It is a perfect spot to Snorkel and delight in submerged marine life. Return once again to the lodging for lunch. 
          Enjoy your night for recreation on the own in Beach. 
          Move back to the hotel for overnight stay.</td>
      </tr>
      <tr>
        <td>Day 5</td>
        <td>Port Blair</td>
        <td>After breakfast, enjoy the day at your leisure. 
          Move back to the hotel for overnight sleep.</td> 
      </tr>
      <tr>
        <td>Day 6</td>
        <td>Depart Port Blair</td>
        <td>After breakfast at the hotel, check-out from the hotel (Check-out before 12.00 noon) and travel to the Port Blair Airport to catch your flight to fly back to Chennai. 
          Return back with ever lasting memories of these Emerald Islands.</td>
      </tr>
    </table> 
    <br>
    <br>
    ...
    <form method="POST" action="Payment.php">
      ...
      <input type="package" id="name" name="package" value="MAGICAL ANDAMAN ISLANDS" required><br><br>
      
      <label for="date">Date:</label>
      <input type="date" id="date" name="date" min="2023-10-06" max="2023-11-26" required><br><br>
