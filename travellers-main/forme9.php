...
<table>
      ...
      <tr>
        <td>Day 1</td>
        <td>Hyderadad Arrival</td>
        <td>After your arrival at Hyderabad Railway Station, our tour representatives will meet and transfer you to the hotel.
           Get into the hotel and relax for sometime. 
          You can spend your overnight stay at the hotel.</td>
      </tr>
      <tr>
        <td>Day 2</td>
        <td>Ramoji Film City</td>
        <td>Take your morning breakfast in the hotel. Move to Ramoji Film City for a full day tour and enjoy great pleasure. 
          In the evening, you can come back to the hotel for rest.</td>
      </tr>
      <tr>
        <td>Day 3</td>
        <td>Hyderabad</td>
        <td>After your morning breakfast, get ready for Hyderabad sightseeing tour. 
          You will be visiting the Snow World, NTR Garden, Husain Sagar Lake and so on.
           In the evening, move back to the hotel and enjoy your overnight stay.</td> 
      </tr>
      <tr>
        <td>Day 4</td>
        <td>Hyderabad - Visakhapatnam</td>
        <td>Take your breakfast and proceed for shopping. 
          Later, you can transfer to the Hyderabad Railways Station and start the journey to Visakhapatnam. 
          Enjoy your overnight stay at the hotel.</td>
      </tr>
      <tr>
        <td>Day 5</td>
        <td>Visakhapatnam</td>
        <td>After your reach, just get into the hotel and relax for sometime. Later, visit the Ramakrishna Beach, Kali Temple, Visakha Museum and Victory at Sea. 
          Move back to the hotel for overnight stay.</td>
      </tr>
      <tr>
        <td>Day 6</td>
        <td>Visakhapatnam</td>
        <td>After your breakfast, visit the VUDA Park, Rushikonda, Kambalakonda and The Kailasagiri.
           You can do some shopping and later proceed for your onward journey.</td>
      </tr>    
    </table> 
    <br>
    <br>
    ...
    <form method="POST" action="Payment.php">
      ...
      <input type="package" id="name" name="package" value="DECCAN HERITAGE TOUR" required><br><br>
      
      <label for="date">Date:</label>
      <input type="date" id="date" name="date" min="2024-02-06" max="2024-03-29" required><br><br>
