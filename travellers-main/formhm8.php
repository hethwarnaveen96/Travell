...
<table>
      ...
      <tr>
        <td>Day 1</td>
        <td>Delhi - Jaipur</td>
        <td>After your arrival at Delhi Airport/ Railway Station, our tour representatives will meet and drive you to the Pink City of Jaipur (265 kms /5 hrs). 
          On the way, visit the Amber Fort and have fun with an elephant ride. On landing in Jaipur, move to lodging. 
          In the evening, just look into some of the brilliant business of Jaipur.</td>
      </tr>
      <tr>
        <td>Day 2</td>
        <td>Jaipur</td>
        <td>After morning breakfast, visit the Albert Hall, Hawa Mahal, Visit City Palace, Jantar Mantar. 
          Later, continue your trip to Ajmer (135 kms/3 hrs). 
          Proceed to the popular Dargah of Salim Chisti and after that drive to Pushkar (11 kilometers.) .
          Visit Pushkar Lake and the most important Brahma Temple in India.</td>
      </tr>
      <tr>
        <td>Day 3</td>
        <td>Jaipur - Udaipur</td>
        <td>On this day, travel to Udaipur (286 kms / 6 hrs). 
          It was the capital of Sawai Dynasty. On arrival, check into the hotel and relax for sometime. 
          Later, visit the popular Jagdish sanctuary which consecrates a dark stone picture of Lord Vishnu Ias Jagannath- Lord of the universe, City Palace of the Maidens" on the bank of Pichori Lake and the Saheliyon ki bari Gardens.</td> 
      </tr>
      <tr>
        <td>Day 4</td>
        <td>Udaipur – Mount Abu</td>
        <td>On the fourth day morning, drive to Mount Abu (190 kms/ 4.5 hrs) and explore great knowledge. 
          Mount Abu is situated at a height of 1,220 mts. delegated at the most astonishing peak of the Aravali Hills .After your reach, get into the hotel and relax for sometime. 
          Later, visit the brilliant Dilwara Jain Temples, Sunset point and Nakki Lake.</td>
      </tr>
      <tr>
        <td>Day 5</td>
        <td>Mount Abu - Delhi</td>
        <td>On the last day morning, drive to Delhi Arrive Delhi and transfer to Airport / Railway Station for onward journey.</td> 
      </tr>
    </table> 
    <br>
    <br>
    ...
    <form method="POST" action="Payment.php">
      ...
      <input type="package" id="name" name="package" value="ROMANTIC JAIPUR DELIGHT" required><br><br>
      
      <label for="date">Date:</label>
      <input type="date" id="date" name="date" min="2024-02-15" max="2024-03-25" required><br><br>
