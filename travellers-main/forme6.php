...
<table>
      ...
      <tr>
        <td>Day 1</td>
        <td>Wayanad</td>
        <td>After your arrival at Wayanad, check-in the hotel and enjoy at your leisure.
           After refreshment, visit the local sightseeing spots such as Edakkal Caves, Banasura Dam, Muthunga wildlife sanctuary. 
          Get back to the hotel for overnight stay.</td>
      </tr>
      <tr>
        <td>Day 2</td>
        <td>Wayand - Cochin</td>
        <td>On the second day morning after breakfast, visit the Pookat Lake and Meenmutty waterfalls.
           After dinner, move to Cochin in the night by bus.</td>
      </tr>
      <tr>
        <td>Day 3</td>
        <td>Cochin</td>
        <td>Upon arrival at Cochin, fresh up and proceed to the Marine drive, hill palace and Chinese fishing net Mattancherry palace. 
          Evening free for shopping Later, move to your home town by carrying sweet memories of Kerala.</td>
      </tr>      
    </table> 
    <br>
    <br>
    ...
    <form method="POST" action="Payment.php">
      ...
      <input type="package" id="name" name="package" value="CAPTIVATING KERALA" required><br><br>
      
      <label for="date">Date:</label>
      <input type="date" id="date" name="date" min="2023-10-09" max="2023-11-19" required><br><br>
