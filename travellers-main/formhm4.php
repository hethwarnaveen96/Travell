...
<table>
      ...
      <tr>
        <td>Day 1</td>
        <td>Cochin - Munnar</td>
        <td>On arrival at Cochin Railway Station or Airport, our tour representatives will reach and move ahead to Munnar (130 kms/ 4 hrs). 
          It is one of the most popular hill stations in Southern India known for its sprawling tea enclosures. 
          Enjoy the evening at your leisure.</td>
      </tr>
      <tr>
        <td>Day 2</td>
        <td>Munnar</td>
        <td>After breakfast, drive through the tea gardens and visit Mettupatty Dam to get pleasure at cruise ride, Kundala Lake, Echo point.</td>
      </tr>
      <tr>
        <td>Day 3</td>
        <td>Munnar - Kumarakom</td>
        <td>After morning breakfast, continue to Kumarakom (160 kms/ 4 hrs). 
          On arrival at Kumarakom, get into the hotel and relax for sometime. 
          In the evening, enjoy in the back waters voyage at the extraordinary resort arranged on the pleasant Vembanad Lake.</td> 
      </tr>
      <tr>
        <td>Day 4</td>
        <td>Kumarakom - Alleppey</td>
        <td>After morning breakfast, drive to Alleppey ( 36 kms). 
          Get into your hotel/ house boat and relax for sometime. 
          In the evening, relax in back waters cruise through the channels & coir towns.</td>
      </tr>
      <tr>
        <td>Day 5</td>
        <td>Alleppey - Cochin</td>
        <td>On the last day morning, you will land at the Alleppey Boat Jetty & move ahead to Cochin (90 kms / 1.5 hrs) Board the flight/ train for forward journey.</td> 
      </tr>
    </table> 
    <br>
    <br>
    ...
    <form method="POST" action="Payment.php">
      ...
      <input type="package" id="name" name="package" value="KERALA LOVERS PARADISE" required><br><br>
      
      <label for="date">Date:</label>
      <input type="date" id="date" name="date" min="2023-12-05" max="2024-01-28" required><br><br>
