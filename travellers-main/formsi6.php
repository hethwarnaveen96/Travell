...
<table>
      ...
      <tr>
        <td>Day 1</td>
        <td>Madurai</td>
        <td>Upon Arrival at Madurai. 
          Our representative receives You Hotel at Madurai. 
          Later proceed on a sightseeing Tour of Madurai. 
          Visit the Meenakshiamman temple, Pazhamudir cholai, thiruparankundram temple and Theppakulam. 
          Enjoy the light and sound show at thirumanalaik hall.
          Overnight stay at Hotel in Madurai.</td>
      </tr>
      <tr>
        <td>Day 2</td>
        <td>Madurai - Kodaikanal</td>
        <td>Take your morning breakfast and move to Kodaikanal from Madurai. 
          On arrival, get into the hotel at Kodaikanal. 
          Later, view the Bryant's Parkand Lake. 
          Spend your overnight stay at the hotel in Kodaikanal.</td>
      </tr>
      <tr>
        <td>Day 3</td>
        <td>Kodaikanal</td>
        <td>Today, set on a touring voyage through Kodaikanal. 
          Visit the green Valley view, Coaker's walk, column rocks, Shenbaganoor museum, Chettiyar Park, Waterfalls. 
          Return back to hotel at Kodaikanal for overnight stay.</td> 
      </tr>
      <tr>
        <td>Day 4</td>
        <td>Kodaikanal - Madurai</td>
        <td>After morning breakfast, move ahead for touring to Madurai. 
          Visit the Gandhimuseum and Alagar Koil. 
          Enjoy your night stay at the inn in Madurai.</td>
      </tr>
      <tr>
        <td>Day 5</td>
        <td>Madurai - Rameshwaram (175 KMS - 04 Hours drive)</td>
        <td>Have your breakfast and check out from hotel. 
          Drive to Rameshwaram, on reaching check in to the hotel. 
          By noon, continue for touring to Rameshwaram and visit Ramjharokatemple, Ramanathaswamy temple, Agnitheertham, Dhanushkodi and Adam's Bridge. 
          Spend your night stay at the inn in Rameshwaram.</td> 
      </tr>
      <tr>
        <td>Day 6</td>
        <td>Rameshwaram - Kanyakumari(250 KMS - 06 Hours drive)</td>
        <td>After your breakfast, check out from inn and drive to Kanyakumari. 
          Upon arrival, check into lodging. 
          In the noon, taste some delicious meals and continue for touring to Kanyakumari and visit Devi.
          Kanyakumari temple, Suchithram Sanctuary, Vivekananda Rock, Triveni Sangam and Gandhi Commemoration. 
          Enjoy the Nightfall (sunset) of Kanyakumari. 
          Move back to the hotel for overnight stay.</td>
      </tr>
      <tr>
        <td>Day 7</td>
        <td>Kanyakumari - Trivandrum (100 KMS - 03 Hours drive)</td>
        <td>On the last day of your trip, after morning breakfast check out from lodging and drive to Trivandrum. 
          On the way, visit the Sri Padmanabhapuram Castle, Additionally, visit the Sri Padmanabhaswamy templein Trivandrum which is the wealthiest sanctuary on the planet, Storehouse, Secretariat and so on. 
          Later, you will be dropped at the Airplane terminal/Line Station for forward excursion.</td>
    </table> 
    <br>
    <br>
    <br>
    ...
    <form method="POST" action="Payment.php">
      ...
      <input type="package" id="name" name="package" value="EXOTIC TAMIL NADU TOUR" required><br><br>
      
      <label for="date">Date:</label>
      <input type="date" id="date" name="date" min="2024-01-10" max="2024-02-25" required><br><br>
