...
<table>
      ...
      <tr>
        ...
        <td>After your arrival from Railway Station / Airport, meet our tour representatives and they will drive you to Nainital.
           Check into the hotel and relax for sometime. 
           In the evening, enjoy a great time in the Mall Road and Boat ride at Naini Lake.
      ...
      <tr>
        ...
        <td>Take your breakfast in the morning.
           Our tour guide will take you for a lake tour to Sat Tal, Naukuchia Tal and Bhim Tal.
           In the noon, check out the Snow View Point, Rope Way and Mall Road. 
          Move back to the hotel for dinner</td>
      </tr>
      <tr>
        <td>Day 3</td>
        <td>Nanital to Corbett National Park ( 60 kms 2 hrs)</td>
        <td>After your breakfast, proceed to Corbett and look over some amazing tourist spots. 
          The first place to visit is the Corbett Fall & Museum where you can find amazing collections of artifacts. 
          Get into the hotel and take a break for sometime. Refresh and visit the Corbett National Park with our guide.
           Nestled in the foothills of Himalayas, Corbett National Park is a beautiful park that holds a large variety of flora and fauna. 
          This park is renowned for its huge population of Leopards, Tigers and Elephants.
           Later, you can enjoy dinner in the hotel.</td> 
      </tr>
      <tr>
        <td>Day 4</td>
        <td>Corbett - Delhi (280kms/7hrs)</td>
        <td>Take your breakfast and move to Delhi.
           Our tour representatives will drop you in the Railway Station or Airport for your departure.</td>
      </tr>
    </table> 
    <br>
    <br>
    ...
    <form method="POST" action="Payment.php">
      ...
      <input type="package" id="name" name="package" value="EXOTIC CORBETT NAINITAL TOUR" required><br><br>
      
      <label for="date">Date:</label>
      <input type="date" id="date" name="date" min="2023-09-13" max="2023-10-29" required><br><br>
