...
<table>
      ...
      <tr>
        <td>Day 1</td>
        <td>Kanyakumari</td>
        <td>On arrival at Kanyakumari, check-in the hotel, take some rest and get ready for a local sightseeing tour. 
          Visit the Sunset Point - the most beautiful features of Kanyakumari, Triveni Sangamam and the ancient temple - Devi Bhagavathi Amman Temple.
           Spend your overnight stay at Kanyakumari hotel.</td>
      </tr>
      <tr>
        <td>Day 2</td>
        <td>Kanyakumari</td>
        <td>On the second day after a healthy breakfast, set to Thiruvalluvar statue (133 feet), Tiruparapu Waterfalls, Vivekananda Rock memorial - a sacred monument, Padmanaban palace. 
          Depart by evening to home town with lovable memories of exotic Kanyakumari.</td>
      </tr>
    ...
    <form method="POST" action="Payment.php">
      ...
      <input type="package" id="name" name="package" value="BEST OF KANNYAKUMARI" required><br><br>
      
      <label for="date">Date:</label>
      <input type="date" id="date" name="date" min="2023-09-25" max="2023-10-29" required><br><br>
