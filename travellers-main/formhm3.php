...
<table>
      ...
      <tr>
        <td>Day 1</td>
        <td>Delhi – Jim Corbett</td>
        <td>On Arrival at Delhi Airport/ Railway Station, our tour representatives will meet and transfer you to the vehicle. 
          Move ahead to Corbett National Park (300 kms / 7 hrs). 
          Later move on to your wilds resort and relax. Spend your overnight stay at resort.</td>
      </tr>
      <tr>
        <td>Day 2</td>
        <td>Jim Corbett</td>
        <td>On early morning, get ready to an amusement drive in the recreation centre by jeep to view the absolute most extraordinary wild life and the greenery. 
          In the noon, move ahead for an alternate diversion review drive and try to watch the wild tiger. 
          Enjoy the evening at your leisure.</td>
      </tr>
      <tr>
        <td>Day 3</td>
        <td>Jim Corbett - Nainital</td>
        <td>On the third day morning, you will be transferred to Nainital (116 kms/ 3 hrs). 
          Nainital is situated amidst the high ridges thickly clothed in forest of pines and deciduous trees. 
          On arrival, carry on to your hotel. 
          By noon, you will be taken for the sightseeing tour of Nainital to visit the Naini Peak. 
          Later, enjoy an optional cable car ride or enjoy boating on the picturesque Naini lake.</td> 
      </tr>
      <tr>
        <td>Day 4</td>
        <td>Nainital - Mussoorie</td>
        <td>On this day morning, move ahead to Mussoorie which is known as the Queen of the Hills. 
          The spot is known for its grand magnificence. On entry, sign in with the lodging. 
          Refresh and get ready for visiting the Municipal Gardens, Gun Hill, Mall Road, Picture castle.</td>
      </tr>
      <tr>
        <td>Day 5</td>
        <td>Mussoorie - Delhi</td>
        <td>On the last day morning, drive to Delhi Airport / Railway Station for onward journey.</td> 
      </tr>
    </table> 
    <br>
    <br>
    ...
    <form method="POST" action="Payment.php">
      ...
      <input type="package" id="name" name="package" value="GLIMPSES OF KASHMIR" required><br><br>
      
      <label for="date">Date:</label>
      <input type="date" id="date" name="date" min="2024-04-20" max="2024-05-18" required><br><br>
