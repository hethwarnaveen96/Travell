...
<table>
      ...
      <tr>
        <td>Day 1</td>
        <td>Cochin</td>
        <td>Upon your arrival at Cochin, our representatives will meet and transfer you to the hotel. 
          Get into the hotel and relax for sometime. After your lunch, move ahead for touring excursion to Cochin. 
          Visit the Dutch Palace Museum, Hill Palace Museum, Jewish Street, St. Francis Church, Jewish Synagogue and Chinese Fishing Nets. 
          Spend your overnight stay at the hotel in Cochin.</td>
      </tr>
      <tr>
        <td>Day 2</td>
        <td>Cochin - Alleppey (65 KMS - 02 Hours drive)</td>
        <td>Following your morning breakfast, check out from hotel and drive to Alleppey. 
          On arrival, check into the resort. 
          Take a break for lunch and move ahead for tour excursion to Alleppey. 
          In the evening, enjoy the chill breeze of the Alleppey Beach. 
          Get to the hotel or resort in Alleppey for overnight stay.</td>
      </tr>
      <tr>
        <td>Day 3</td>
        <td>Alleppey - Kumarakom (40 KMS - 01 Hour drive)</td>
        <td>After your morning breakfast, check out from lodging or resort and drive to Kumarakom. 
          After your reach, get into Kumarakom Houseboat (weigh in time 12.30 PM). 
          Enjoy a full day delight in the backwater journey through Vembanad Lake. 
          You can enjoy your overnight stay at Houseboat in Aleppey Backwaters.</td> 
      </tr>
      <tr>
        <td>Day 4</td>
        <td>Kumarakom - Cochin (100 KMS - 03 Hours drive)</td>
        <td>After breakfast, check out from Houseboat (look at time 9.30 AM) and drive to Cochin Airport/ Railway Station for forward adventure.</td>
      </tr>
    </table> 
    <br>
    <br>
    ...
    <form method="POST" action="Payment.php">
      ...
      <input type="package" id="name" name="package" value="MESMERIZING BACKWATERS TOUR" required><br><br>
      
      <label for="date">Date:</label>
      <input type="date" id="date" name="date" min="2023-12-19" max="2024-01-31" required><br><br>
