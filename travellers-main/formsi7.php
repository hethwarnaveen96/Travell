...
<table>
      ...
      <tr>
        <td>Day 1</td>
        <td>Munnar</td>
        <td>Upon your arrival at Cochin, you will be met by our tour representative and tarnsferred to the Munnar inn. 
          Refresh and get ready to visit Anaimudi peak- the most astonishing peak, Devikulam, Mettupatti Dam. 
          Later, get back to the lodging for an overnight stay.</td>
      </tr>
      <tr>
        <td>Day 2</td>
        <td>Munnar</td>
        <td>After morning breakfast, move ahead to Rajamala, Nyayamakad, Echo Point, Kundala, Power House Waterfalls, Malankara Reservoir. 
          Enjoy your overnight stay at Munnar Hotel.</td>
      </tr>
      <tr>
        <td>Day 3</td>
        <td>Thekkady</td>
        <td>Take your morning breakfast at the hotel. 
          Proceed to Thekkady (Periyar)-India's most fascinating characteristic natural life sanctuary. 
          After your arrival at Thekkady, check in lodging and later move out for the nearby visit. 
          Have a look at The Periyar wildlife sanctuary and Periyar Lake. 
          Spend your overnight stay at Thekkady Lodging.</td> 
      </tr>
      <tr>
        <td>Day 4</td>
        <td>Thekkady</td>
        <td>Have your morning breakfast and move ahead to Mangala Devi Temple, Kumily, Vandiperiyar. 
          After lunch, just relax in the hotel.</td>
      </tr>
      <tr>
        <td>Day 5</td>
        <td>Cochin</td>
        <td>After morning banquet, travel to Cochin. 
          Transfer to Cochin airport/railway station for your return.</td> 
      </tr>
    </table> 
    <br>
    <br>
    ...
    <form method="POST" action="Payment.php">
      ...
      <input type="package" id="name" name="package" value="ENCHANTING KERALA DELIGHT" required><br><br>
      
      <label for="date">Date:</label>
      <input type="date" id="date" name="date" min="2023-10-05" max="2023-11-16" required><br><br>
