...
<html>
    ...
    <body>
              ...
              <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="nav navbar-nav ms-auto" >
                  ...
                  <li class="nav-item" id="li" >
                    <a class="nav-link" id="li-a" href="Packages.html">PACKAGES</a>
                  </li>
        ...
        <div id="carouselExampleCaptions" class="carousel slide carous" data-bs-ride="false" style="margin-top:118px;">
            ...
            <div class="carousel-inner">
              <div class="carousel-item active">
                ...
                <div class="carousel-caption  ">
                  <strong><h2>Find your best holiday</h2></strong>
                  <p>Craft your holiday in your own way</p>
                </div>
              </div>
              <div class="carousel-item ">
                <img src="./images/bg2.jpg" class="d-block w-100" alt="...">
                <div class="carousel-caption ">
                  <h5>Discover the world with us</h5>
          ...
          <div class="button">
            <a href="./Packages.html"><button  class="btn">EXPLORE NOW</button></a>
