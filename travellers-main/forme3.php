...
<table>
      ...
      <tr>
        <td>Day 1</td>
        <td>Bangalore</td>
        <td>On arrival at Bangalore, check-in the hotel and take some rest. 
          Our tour representatives will take you for a city tour to visit the Lal Bagh Gardens – Red Garden in terms of English, is an outstanding botanical garden in southern Bangalore, Vidhana Soudhana - the chief legislature-cum-office edifice in India, visvesvaraya museum and Cubbon Park Bangalore Park. 
          In the evening, proceed to shopping in the MG Road. 
          Spend your overnight stay at the hotel.</td>
      </tr>
      <tr>
        <td>Day 2</td>
        <td>Bangalore</td>
        <td>On the second day morning after breakfast, visit Iskcon temple which is the International Society for Krishna Consciousness.
           Continue to Bannerghatta national park and enjoy free shopping later. 
          After a healthy breakfast, move to Wonderla which is Asia’s largest theme park.
           By evening, depart to home town with sweet memories of Bangalore.</td>
      </tr>
    ...
    <form method="POST" action="Payment.php">
      ...
      <input type="package" id="name" name="package" value="BANGALORE HOLIDAY TOUR" required><br><br>
      
      <label for="date">Date:</label>
      <input type="date" id="date" name="date" min="2024-01-01" max="2024-02-03" required><br><br>
