...
<table>
      ...
      <tr>
        <td>Day 1</td>
        <td>Arrival at Bangalore</td>
        <td>Upon your arrival at Bangalore Railway Station or Airport, you will be greeted by our tour agent and taken to the hotel. 
          By noon, continue for touring to Bangalore and visit Cubbon Park, Lalbagh Botanical Garden, Tipu Sultan's Summer Palace, Vidhana Soudha, Bangalore Palace, Bull Temple and St. Patrick's Church. 
          Spend your overnight stay at the hotel in Bangalore.</td>
      </tr>
      <tr>
        <td>Day 2</td>
        <td>Bangalore - Mysore (140 KMS - 03 Hours drive)</td>
        <td>After morning breakfast, check out from the hotel and drive to Mysore. 
          Upon arrival, get into the hotel and relax for sometime.
           Enjoy the day at your leisure.
           Move back to the hotel in Mysore for overnight stay.</td>
      </tr>
      <tr>
        <td>Day 3</td>
        <td>Mysore</td>
        <td>Have your breakfast and move ahead for touring to Mysore. 
          Visit the Chamundi Hills, Brindavan Gardens, Mysore Lake, Mysore Amusement Mysore Zoo and St.Philomena's Church.
           Return back to the hotel for overnight stay.</td> 
      </tr>
      <tr>
        <td>Day 4</td>
        <td>Mysore - Coorg (110 Kms. - 02 ½ Hrs)</td>
        <td>After morning breakfast, check out from the hotel and move ahead to Coorg. 
          After your arrival, get into the hotel and relax for sometime. 
          Enjoy the day at recreation. 
          Spend your overnight stay at the hotel in Coorg.</td>
      </tr>
      <tr>
        <td>Day 5</td>
        <td>Coorg</td>
        <td>On fifth day, after breakfast move ahead for touring voyage through Coorg - enroute visit Nagarhole National Park, Madikeri Fort, Iruppu Falls, Raja's Seat, Abbey Falls and Omkareshwara Temple.
           Return back to the hotel/resort in Coorg for overnight stay.</td> 
      </tr>
      <tr>
        <td>Day 6</td>
        <td>Coorg - Bangalore (250 KMS - 06 Hours drive)</td>
        <td>After morning breakfast, pack your luggage with a thought of returning again to this sweet fortune.
           Depart from the hotel and move ahead to Bangalore Airport/Railway Station.</td>
      </tr>
    </table> 
    <br>
    <br>
    ...
    <form method="POST" action="Payment.php">
      ...
      <input type="package" id="name" name="package" value="SUPER SAVER HOLIDAY PACKAGE" required><br><br>
      
      <label for="date">Date:</label>
      <input type="date" id="date" name="date" min="2023-12-12" max="2024-01-29" required><br><br>
