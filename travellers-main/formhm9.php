...
<table>
      ...
      <tr>
        <td>Day 1</td>
        <td>Delhi - Manali</td>
        <td>Upon arrival at Delhi Airport, you will be greeted by our representative and transferred to the Manali. 
          Sign in to the hotel and spend your overnight stay at hotel.</td>
      </tr>
      <tr>
        <td>Day 2</td>
        <td>Manali – Rohtang Pass - Manali</td>
        <td>On second day morning, get ready to enjoy unbelievable drive towards Rohtang Pass. 
          It is situated at an altitude of 3,980 meters and enjoy in snow. 
          Rohtang Pass is 51 kms left from Manali. 
          In the evening, return back to Manali.</td>
      </tr>
      <tr>
        <td>Day 3</td>
        <td>Manali</td>
        <td>On this day, visit the ancient temples like Hidimba Temple, Vashistha Temple.</td> 
      </tr>
      <tr>
        <td>Day 4</td>
        <td>Manali – Kullu - Manali</td>
        <td>After morning breakfast, proceed to Manali ( 260 kms. / 9 hrs.) across Sutlej river, Beas River, Kullu valley. 
          Visit Shawl factory at Kullu. 
          Reach Manali in the evening.</td>
      </tr>
      <tr>
        <td>Day 5</td>
        <td>Manali – Day at leisure</td>
        <td>Today is for hangout and you can enjoy the day at your leisure for for shopping.</td> 
      </tr>
      <tr>
        <td>Day 6</td>
        <td>Manali – Delhi</td>
        <td>On the last day after breakfast, depart to Delhi Airport to get your return flight.</td> 
      </tr>
    </table> 
    <br>
    <br>
    ...
    <form method="POST" action="Payment.php">
      ...
      <input type="package" id="name" name="package" value="ROMANTIC HIMACHAL" required><br><br>
      
      <label for="date">Date:</label>
      <input type="date" id="date" name="date" min="2024-03-03" max="2024-04-26" required><br><br>
