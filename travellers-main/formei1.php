...
<table>
      ...
      <tr>
        <td>Day 1</td>
        <td>Arrival Njp Railway Station / (Ixb) Bagdogra Airport - Gangtok</td>
      ...
      <tr>
        ...
        <td>Take your breakfast in the morning.
           Get ready for a pleasure trip to Tshangu Lake - located at a height of 12400Ft / 3780 Mts / 43Kms in 3Hrs. 
           The cool water of the Lake is absolutely adjusted with the picturesque beauty around. 
           Return back to Gangtok and spend your overnight stay at the hotel. 
      ...
      <tr>
        <td>Day 3</td>
        <td>Gangtok - Darjeeling (40 KMS - 01 Hour drive)</td>
        <td>After morning breakfast, transport to Darjeeling (7380 Ft / 2250 Mts, 115 Kms / 05 to 06 Hrs). 
          By noon, get ready for a half-day sightseeing tour to Peace pagoda, Japanese Temple, Himalayan Mountaineering Institute (Closed on Thursday) & Padmaja Naidu Himalayan Zoological Park, Tenzing & Gombu Rock, Tibetan Refugee Self-Help Center (Closed on Sunday) and Tea Estate. 
          Spend your overnight stay at the hotel.</td> 
      </tr>
      <tr>
        <td>Day 4</td>
        <td>Darjeeling - Njp Railway / Ixb Airport</td>
        <td>Early morning, take a trip to Tiger Hills (8364 Ft / 2550 Mts at around 4 AM) to view dawn over Kanchendzonga Peak (subject to clear climate). 
          Ensure to stopover at Ghoom Monastery and Asia Loop. Have your morning breakfast and proceed to NJP Railway Station / (IXB) Bagdogra Airport (100 Kms / 03 to 04 Hrs Hrs) for your onward journey.</td>
      </tr>
    </table> 
    <br>
    <br>
    ...
    <form method="POST" action="Payment.php">
      ...
      <input type="package" id="name" name="package" value="AMAZING DARJEELING TOUR" required><br><br>
      
      <label for="date">Date:</label>
      <input type="date" id="date" name="date" min="2024-04-08" max="2024-05-31" required><br><br>
