...
<table>
      ...
      <tr>
        <td>Day 1</td>
        <td>Kodaikanal</td>
        <td>In the early morning, drive to Kodaikanal and explore great fun. 
          On the way, admire the beauty of the green mountains dressed up with the mist. 
          On arrival in Kodaikanal, get into the hotel and relax for sometime. 
          Visit the Silver fall and get wet in the chill water. 
          Later, proceed to the Chettiya park, Bryant Park, Kodaikanal lake boating.
          In the evening, hang out for shopping and spend your overnight stay at the hotel.        </td>
      </tr>
      <tr>
        <td>Day 2</td>
        <td>Kodaikanal</td>
        <td>Take your morning breakfast and get ready to visit the beautiful place. 
          Move to the Pillar rock, Guan point, and Sunset point. 
          Go on a breathtaking walk inside the mist at Cockers walk and by evening set to home town by carrying sweet memories of Kodai.</td>
      </tr>
    ...
    <form method="POST" action="Payment.php">
      ...
      <input type="package" id="name" name="package" value="SOUTH INDIAN ECTASY TOUR" required><br><br>
      
      <label for="date">Date:</label>
      <input type="date" id="date" name="date" min="2023-10-03" max="2023-10-30" required><br><br>
