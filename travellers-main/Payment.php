 ...
 *, *::before, *::after {
 ...
 .payment__shadow-dots {
	 ...
	 width: 6.5rem;
	 height: 11.5rem;
	 background: linear-gradient(to bottom, #e0ecf7 0 0%, #fff 100%);
	 z-index: 200;
}
 .card {
	 grid-column: 0.5;
	 ...
	 box-shadow: -0.6rem 0.6rem 1.8rem #4f46f8 3d;
...
<div class="container">
  <div class="payment">
    ...
    <form class="form" action="paydb.php" method="POST">
      <h2>Payment Details</h2><br>
      
      <div class="form__name form__detail">
        <label for="name">Cardholder Name</label>
        <ion-icon name="person-outline"></ion-icon>
        <input type="text" placeholder="Mrs Kate Smith" id="name" maxlength="24"><br>
      ...
      <div class="form__number form__detail">
        ...
        <input type="text" placeholder="0000 0000 0000 0000" id="number" name="card_no" onkeypress="return isNumeric(event)">
      ...
      <div class="form__expiry form__detail">
        ...
        <input type="text" placeholder="MM/YY" id="date" name="exp_date" onkeypress="return isNumeric(event)" >
