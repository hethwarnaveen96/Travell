...
<table>
      ...
      <tr>
        <td>Day 1</td>
        <td>Leh</td>
        <td>After your arrival at Leh Airport, you will be received by our agent and moved to the hotel. 
          A hot glass of welcome coffee/tea anticipates you at the inn. 
          Take complete rest for the day. 
          Take your lunch and enjoy a leisure walk around Leh on your own.</td>
      </tr>
      <tr>
        <td>Day 2</td>
        <td>Leh</td>
        <td>On this day, our tour representatives will take you for a full day outing to Shey Palace, Hemis and Gompas Thiksey. 
          Shey Gompas lies on the side to Hemis. 
          It is arranged on the highest point of the slope and houses the biggest Victory stupa with a brilliant top. 
          The statues made of copper and coasted with gold are worth seeing. 
          Thiskey Gompa lies on the left half of this street to Hemis. 
          One can have an excellent perspective of Indus Valley from Gompa. 
          Wall depictions of this Gompa are extremely fascinating. 
          Later, drive to Hemis which is the most established, wealthiest and biggest Gompa in Leh with lovely canvases, stupas.
           Enjoy your supper and overnight stay in the hotel at ley.</td>
      </tr>
      <tr>
        <td>Day 3</td>
        <td>Leh – Ladakh - Leh</td>
        <td>Today, you will be taken for a full day journey to Pangong Lake (160 Kms 06.00 hrs). 
          Drive to Pangong Lakevia Changla Pass. Take your lunch at Tangtse. 
          Continue your journey towards the Pangong Lake. 
          It is regarded as the main salt water lake in Asia. 
          Move on to Leh. 
          Arrive Leh by night.</td> 
      </tr>
      <tr>
        <td>Day 4</td>
        <td>Leh – Ladakh - Leh</td>
        <td>After breakfast, drive to Khardung la most noteworthy street in the World situated at an elevation of 18300 feet. 
          In the evening, return to Leh and take some rest. 
          Afterwards, move ahead to visit Magnetic Hill Gurudwara Pather Sahib, and Sangam of Zanskar and Indus River.</td>
      </tr>
      <tr>
        <td>Day 5</td>
        <td>Leh</td>
        <td>Move to airport to catch your flight. 
          Fly once again with sweet memories of Ladakh.</td> 
      </tr>
    </table> 
    <br>
    <br>
    ...
    <form method="POST" action="Payment.php">
      ...
      <input type="package" id="name" name="package" value="ROMANTIC LADAKH TOUR" required><br><br>
      
      <label for="date">Date:</label>
      <input type="date" id="date" name="date" min="2024-05-15" max="2024-06-27" required><br><br>
