...
<table>
      ...
      <tr>
        <td>Day 1</td>
        <td>Pune</td>
        <td>Upon arrival at Pune Railway Station, meet our tour representatives and get transferred to Pune hotel. 
          Refresh and relax at the hotel.
           Spend your overnight stay at your own.</td>
      </tr>
      <tr>
        <td>Day 2</td>
        <td>Pune - Lonavala</td>
        <td>After morning breakfast, check-out the hotel and proceed to Lonavala (65 Kilometers 1hrs 30 mins), Lonavala sightseeing include Lohgarh fort, Karala cave’s, and Lake. 
          You can move back to Pune in the evening.
           Enjoy your overnight stay at hotel.</td>
      </tr>
      <tr>
        <td>Day 3</td>
        <td>Pune - Mumbai</td>
        <td>On this day, transfer to Mumbai. On arrival at evening, visit Hotel Taj Mahal Palace and Nariman point. 
          Get back for overnight stay to the hotel.</td> 
      </tr>
      <tr>
        <td>Day 4</td>
        <td>Mumbai</td>
        <td>After morning breakfast, proceed for sightseeing of Mumbai.
           Mumbai local sightseeing includes The Gateway of India and the chief entry port of India is a largest industrial centre and is supposed to be the most cosmopolitan city in the east. 
          Check out the Juhu beach and Elephant cave.
           Enjoy your overnight stay at hotel.</td>
      </tr>
      <tr>
        <td>Day 5</td>
        <td>Mumbai - Goa</td>
        <td>After breakfast, get on a train to Goa. 
          On arrival at Goa Airport, our tour manager will meet and greet you and transfer to Goa Resort.
           You can enjoy the rest of the day for leisure and spend your overnight stay at hotel.</td>
      </tr>
      <tr>
        <td>Day 6</td>
        <td>South Goa</td>
        <td>After morning breakfast, proceed for South Goa sightseeing tour covering Temples of Shri Manguesh and Shri Shanthadurga, Miramar, Ancestral Goa- Loutlim, Dona Paula Bay and Arabian Sea covering Panaji Handicrafts emporium, Mayem Lake, Shrisapta Koteshwar Mandir at Narve, and enjoy the beaches of evening 06.00 pm Boat Cruises (Goa Cultural Dance). 
          Return back to hotel for overnight stay.</td>
      </tr> 
      <tr>
        <td>Day 7</td>
        <td>North Goa</td>
        <td>Morning after breakfast, take rest for sometime and later trip to Goa local sightseeing Vagator, Calangute, Anjuna, and Fort Aguada (famous for Churches).
           Get back for overnight stay to the hotel.</td>
      </tr>
      <tr>
        <td>Day 8</td>
        <td>South Goa</td>
        <td>On the last day morning after breakfast, day free for shopping and evening board a train back to your home town.</td>
      </tr>    
    </table> 
    <br>
    <br>
    ...
    <form method="POST" action="Payment.php">
      ...
      <input type="package" id="name" name="package" value="THE INDIAN SPLENDOR PACKAGE" required><br><br>
      
      <label for="date">Date:</label>
      <input type="date" id="date" name="date" min="2024-01-14" max="2024-02-24" required><br><br>
