...
<table>
      ...
      <tr>
        <td>Day 1</td>
        <td>Arrive Goa</td>
        <td>Upon your arrival at Goa, our tour representatives will welcome and transfer you to the hotel. 
          Get into the hotel and relax for sometime. 
          Enjoy the rest of the day by visiting some of the nearby tourist attractions. 
          Spend your overnight stay at the hotel.</td>
      </tr>
      <tr>
        <td>Day 2</td>
        <td>Goa</td>
        <td>After your morning breakfast, get ready for a full day touring voyage through South Goa. 
          Ensure to visit the Old Goa Churches-Mangueshi Temple-Dona Paula, emulated by vessel journey at the River Mondovi. 
          In the night, return back to the hotel for night stay.</td>
      </tr>
      <tr>
        <td>Day 3</td>
        <td>Goa</td>
        <td>Take your morning breakfast in the hotel. 
          After breakfast, continue for a full day touring voyage through North Goa: Dolphins [tickets charges in addition], Beaches and Fort Aguada. 
          Later, return back to the hotel for night stay.</td> 
      </tr>
      <tr>
        <td>Day 4</td>
        <td>Goa - Departure</td>
        <td>After morning breakfast, enjoy the day at your leisure. 
          You can spend a great time in the hotel. 
          By noon, check out from the hotel and continue to Railway Station for your return trip.</td>
      </tr>
    </table> 
    <br>
    <br>
    ...
    <form method="POST" action="Payment.php">
      ...
      <input type="package" id="name" name="package" value="GOLDEN SANDS HONEYMOON PACKAGE" required><br><br>
      
      <label for="date">Date:</label>
      <input type="date" id="date" name="date" min="2023-12-27" max="2024-01-19" required><br><br>
