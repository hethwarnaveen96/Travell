...
<table>
      ...
      <tr>
        <td>Day 1</td>
        <td>Arrival Jaipur</td>
        <td>Upon your arrival at Jaipur Railway station / Airport, you will be received by our tour representatives and taken to the hotel.
           Refresh and relax. 
          In the evening, you can just walk around the town and enjoy. 
          Spend your overnight stay at the Jaipur hotel.</td>
      </tr>
      <tr>
        <td>Day 2</td>
        <td>Jaipur</td>
        <td>Take your breakfast in the morning.
           Our tour representatives will take you for a day time trip to Amber Fort. 
           The dancing Elephant ride incline to the fort.
            Amber Fort Palace is considered to be the classic romantic Rajasthani fort palace which was progressed by Man Singh I in 1592 and completed by his descendent Jai Singh I.
            Later, enjoy the sightseeing tour of Jaipur. The City Palace is actually a lovely mingle of Mughal and conventional Rajasthani structural design. 
          Move back to hotel in Jaipur for night stay.</td>
      </tr>
      <tr>
        <td>Day 3</td>
        <td>Jaipur - Pushkar (150 kms, 2 hrs)</td>
        <td>Drive to Pushkar and visit the ancient temples, historical monuments and tourist attractions.
           The most recognized is the Brahma Temple which is supposed to be one of the few temples in the world devoted to this divinity.
            It’s marked by red spire, and above the doorway entrance is the Hans, or goose representation of Brahma, who is said to have individually selected Pushkar as its spot. 
          Later, get back to the hotel for overnight stay.</td> 
      </tr>
      <tr>
        <td>Day 4</td>
        <td>Pushkar - Jodhpur (250 kms, 4.5 hrs)</td>
        <td>On this day, you will be taken to Jodhpur. 
          After your arrival, transfer to the hotel and relax for sometime.
           Enjoy the rest of the day at your leisure. Spend your overnight stay at Jodhpur.</td>
      </tr>
      <tr>
        <td>Day 5</td>
        <td>Jodhpur</td>
        <td>After a relaxed breakfast, proceed for city sightseeing tour to Jodhpur. 
          Jodhpur is regarded as the monopoly of the violent Rathore tribe which was founded in 1459 by Prince Jodha. 
          Proceed to Mehrangarh Fort, located on a low stonework hill. Continue your journey towards the Moti Mahal and Phool Mahal.
           Visit the Jaswant Thada, an impressive sandstone cenotaph, built in memory of Maharaja Jaswant singh II about 1899 and Umaid open gardens. 
          Move back to the hotel for overnight stay.</td> 
      </tr>
      <tr>
        <td>Day 6</td>
        <td>Departure</td>
        <td>On the last day, depart from Jaipur and transfer to the airport/ railway station for your return.</td>
      </tr>
    </table> 
    <br>
    <br>
    ...
    <form method="POST" action="Payment.php">
      ...
      <input type="package" id="name" name="package" value="GOLDEN TRIANGLE TOUR WITH JODHPUR" required><br><br>
      
      <label for="date">Date:</label>
      <input type="date" id="date" name="date" min="2023-10-18" max="2023-11-31" required><br><br>
