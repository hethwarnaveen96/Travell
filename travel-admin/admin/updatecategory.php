...
<tr><td colspan="2" class="toptd">UPDATE TOUR</td></tr>
<tr><td class="lefttxt">Select Tour</td><td><select name="t1" required/><option value="">Select</option>
...
<tr><td class="lefttxt">Tour Name</td><td><input type="text"   value="<?php if(isset($_POST["show"])){ echo $Cat_name ;} ?>" name="t2" required pattern="[a-zA-z _]{3,10}" title"Please Enter Only Characters between 3 to 10 for Tour Name"/></td></tr>
